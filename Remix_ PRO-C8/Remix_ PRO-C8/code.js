...
function draw() {
  ...
  if (compScore == 5 || playerScore == 5) {
    playerScore.velocityX=0;
   playerScore.velocityY=0;
   striker.velocityX=0;
   striker.velocityY=0;
  }
...
if(striker.isTouching(goal1))
  ...
  if(gameState==" ")
  {
      ...
      text("PRESIONA ESPACIO PARA GOLPEAR",50,250 );
 ...
 if(gameState == "play")
  {
   striker.velocityX = 3;
    striker.velocityY = 4; 
  if (striker.isTouching(goal1) || striker.isTouching(goal2) || compScore == 5 || playerScore == 5) {
  gameState="end";  
  }
  }
